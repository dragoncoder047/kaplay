    ...
    return {
        ...
        worldPos(this: GameObj<PosComp>, pos: Vec2 | null = null) {
            if (pos) {
                ...
                return this.parent
                    ? this.parent.worldTransform.transformPointV(this.pos, vec2())
                    : this.pos;
            }
        },
        ...
        toWorld(this: GameObj<PosComp>, p: Vec2): Vec2 {
            return this.parent
                ? this.parent.worldTransform.transformPointV(this.pos.add(p), vec2())
                : this.pos.add(p);
        },
        ...
        fromWorld(this: GameObj<PosComp>, p: Vec2): Vec2 {
            return this.parent
                ? this.parent.worldTransform.inverse.transformPointV(p, vec2()).sub(
                    this.pos,
                )
                : p.sub(this.pos);
        },
